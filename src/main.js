...
var sensor_config = requestJSON("/brace-app/assets/sensors.json");
...
var datapoint = requestJSON("/brace-app/assets/data/datapoint0.json");

var loader = new STLLoader();
loader.load("/brace-app/assets/brace.stl", function (geometry) {
    // geometry.center();
